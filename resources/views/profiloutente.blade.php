...
@section('Title', 'Profilo_utente')

@section('content')

@include('bottombar')

<div style="max-height: 800px; margin-top: -50px; background-image: url({{asset('images/image15.jpeg')}})" class="bg-image">
  ...
  <div class="col-md-8">
      ...
      <div class="row" >
          <div class="d-flex justify-content-start" style="margin-top:5%;">
              <form action="{{route('modificaprofilo')}}" method="GET" style=" max-width: 300px; margin-right:3%;">
