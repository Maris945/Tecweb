    ...
    <div class="card">
      ...
      >
        <a
          ...
          >Messaggio<i class="fas fa-envelope ms-2"></i
        ></a>
        <a
          class="btn btn-link m-0 text-reset"
          href="#"
          role="button"
          data-ripple-color="primary"
          >Modifica<i class="fas fa-edit ms-2"></i
        ></a>
      </div>
    </div>
  </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/TecWeb2023/resources/views/userlist.blade.php ENDPATH**/ ?>