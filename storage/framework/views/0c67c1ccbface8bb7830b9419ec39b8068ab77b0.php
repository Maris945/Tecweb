...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <!-- Navbar brand -->
      <a class="navbar-brand mt-2 mt-lg-0" href="<?php echo e(route('homepublic')); ?>">
        <img
          src="<?php echo e(asset('images/image20.png')); ?>"
          height="15"
          alt="MDB Logo"
          loading="lazy"
          style="height: 40px;"
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(route('chisiamo')); ?>">Chi siamo</a>
        </li>
        <li class="nav-item">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/TecWeb2023/resources/views/layouts/nevigationbar.blade.php ENDPATH**/ ?>