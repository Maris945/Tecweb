<?php $__env->startSection('Title', 'Profilo_utente'); ?>

<?php $__env->startSection('content'); ?>

<?php echo $__env->make('bottombar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <div class="col-md-8">
      ...
      <div class="row" >
          <div class="d-flex justify-content-start" style="margin-top:5%;">
              <form action="<?php echo e(route('modificaprofilo')); ?>" method="GET" style=" max-width: 300px; margin-right:3%;">
                  
                      <button type="submit" class="btn btn-light" data-mdb-ripple-color="dark" style=" width: 160px; ">Modifica Profilo</button>
...
<?php echo $__env->make('public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/TecWeb2023/resources/views/profiloutente.blade.php ENDPATH**/ ?>