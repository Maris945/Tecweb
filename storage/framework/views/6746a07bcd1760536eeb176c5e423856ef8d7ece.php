<?php $__env->startSection('title', 'chisiamo'); ?>

<?php $__env->startSection('content'); ?>

<div style="height: 1000px; margin-top: -50px; background-image: url(<?php echo e(asset('images/image11.jpeg')); ?>)" class="bg-image">
...
<?php echo $__env->make('public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/TecWeb2023/resources/views/chisiamo.blade.php ENDPATH**/ ?>