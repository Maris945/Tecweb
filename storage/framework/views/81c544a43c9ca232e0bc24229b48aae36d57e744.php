...
<div class="d-flex justify-content-end" style="margin-right: 150px; margin-top: -40%;;">
    <img src="<?php echo e(asset('images/image7.png')); ?>" style="position: relative; max-width: 40%;">
</div>
...
<?php echo $__env->make('public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/TecWeb2023/resources/views/auth/register.blade.php ENDPATH**/ ?>