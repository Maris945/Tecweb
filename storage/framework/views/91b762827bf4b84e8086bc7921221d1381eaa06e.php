<?php $__env->startSection('title', 'Modifica_Profilo'); ?>

<?php $__env->startSection('content'); ?>

<div style="height: 900px; margin-top: -50px; background-image: url(<?php echo e(asset('images/images6.jpeg')); ?>)" class="bg-image"></div>
...
<div class="container">
  ...
  <label class="btn btn-secondary" for="option2">Non Consentire</label>
        ...
        <div class=" d-flex justify-content-center" style="margin-top: 3%;">
            ...
            <form action="<?php echo e(route('profiloutente')); ?>" method="GET"  style="margin-right: 5%;">
...
<div class="d-flex justify-content-end" style="margin-right: 150px; margin-top: -30%; margin-bottom: 20%;">
    <img src="<?php echo e(asset('images/image14.png')); ?>" style="position: relative; max-width: 35%;">
</div>
...
<?php echo $__env->make('public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/TecWeb2023/resources/views/modificaprofilo.blade.php ENDPATH**/ ?>